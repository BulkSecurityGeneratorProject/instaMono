...
public class InstaMonoApp {

    private static final Logger log = LoggerFactory.getLogger(InstaMonoApp.class);

    private final Environment env;

    public InstaMonoApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes instaMono.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(InstaMonoApp.class);
